...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    lazy var dataStack = DATAStack(modelName:"Tubulus")
    ...
    func application(application: UIApplication, didReceiveLocalNotification notification: UILocalNotification) {
        let alertView = UIAlertView(title: "Vencimento", message: notification.alertBody, delegate: nil, cancelButtonTitle: "Ok")
        alertView.show()
    }
